      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            <ActivitySummary reviews={reviews} claims={claims} isLoading={isLoading} />
            <RecentReviews reviews={reviews} isLoading={isLoading} />
            <AdminDiagnostics />
          </div>
          ...
          <div className="space-y-6">
            ...
            <ClaimRequests claims={claims} isLoading={isLoading} />
            <AdminUpgrade />
          </div>
        </div>
      )}
